/**
 * Created by mikelseverson on 8/19/15.
 */
var app = angular.module('PostmatesApp', []);


app.controller('myController', ['$scope', 'myAuth' , '$http', function($scope, myAuth, $http) {
    myAuth.login('6854a484-6226-43b8-ab7f-0890841bee0a', '');

    $http.post('https://api.postmates.com/v1/customers/cus_KKTBUzym9jC16k/delivery_quotes', {dropoff_address : "20 McAllister St, San Francisco, CA 94102", pickup_address: "101 Market St, San Francisco, CA 94105"})
